 ...
 */
export const TYPE_SPANS: Partial<Record<IconType, number>> = { AIHOT: 6, CHANGELOG: 6, TODO: 6, VIDEO: 6, MODEL: 6, WEATHER: 3 }
...
export const ICON_TYPES = ['NAV', 'STOCK', 'CHANGELOG', 'WEATHER', 'AIHOT', 'TODO', 'VIDEO', 'MODEL', 'GROUP'] as const
type IconType = (typeof ICON_TYPES)[number]

/** 单例类型(见 CONTEXT.md「单例类型」):全局仅一个实例,新增/全量替换两入口同校验。 */
export const SINGLETON_TYPES: readonly IconType[] = ['AIHOT', 'TODO', 'VIDEO', 'MODEL']
