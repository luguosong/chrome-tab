...
> **注记(2026-08-20)**:三档密度模型已被 [ADR-0016](0016-icon-single-size-minimal-density.md) 取代——stock 只剩 small 密度(名称 + 当前价,价格带涨跌色),medium/large 布局与「公司概述子集上 large 网格」废止,公司概述恢复 [ADR-0004](0004-stock-company-overview-eastmoney-frontend.md) 的 Modal 独占。
